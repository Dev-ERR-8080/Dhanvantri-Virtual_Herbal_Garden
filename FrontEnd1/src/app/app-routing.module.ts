...
import { TherapysComponent} from './components/pages/therapys/therapys.component';
...
const routes: Routes = [
  ...
  {path: 'place/:scientificName',component:PlacesContentComponent},
  ...
  {path:'therapys',component:TherapysComponent},
